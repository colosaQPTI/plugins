	...
	return{
			show:function(o)
			{
				...
				if(!p){
					...
					b.className='tcontentM';
					m=document.createElement('div');
					m.className='tmaskM';
					g=document.createElement('div');
					g.className='tcloseM';
					g.v=0;document.body.appendChild(m);document.body.appendChild(j);
					j.appendChild(p);p.appendChild(b);
			...
			fill:function(c,u,k,a,w,h){
				if(u){if(v.image){
					var i=new Image();
					i.onload=function(){
						w=w||i.width;h=h||i.height;TINY.box.psh(i,a,w,h)
					};
					i.src=v.image
				}else if(v.iframe){
			...
			esc:function(e){
				e=e||window.event;if(e.keyCode==27 && false){
					TINY.box.hide()
				}
			},hide:function(){
							...
							ta:function(e,a,d){
								...
								top:function(){
									...
									total:function(d){
										...
										return d?Math.max(Math.max(b.scrollHeight,e.scrollHeight),
												Math.max(b.clientHeight,e.clientHeight)):Math.max(Math.max(b.scrollWidth,e.scrollWidth),
