  		...
  		{  			
			...
			$_SESSION['APPLICATION'] = $newAPP_UID;
     		$_SESSION['APPLICATION_EDIT'] = $newAPP_UID;
  			...
  			//insertHistoryLogPlugin($APP_UID,$USR_UID,$CURRENTDATETIME,$version,$newAPP_UID,'Modification',14); // PM function in aquitineProject Plugin		    
		  	insertHistoryLogPlugin($APP_UID,$auxUsrUID,$CURRENTDATETIME,$version,$newAPP_UID,'Modification',14); // PM function in aquitineProject Plugin		    
