...
$wsdl = PATH_PLUGINS . "obladyConvergence/services" . PATH_SEP . "pmos2.wsdl";
...
/**
 * Webservice getParams
 *
 * @author	Arnaud Rousseau <arnaud@oblady.fr>
 * @return      Return PM table result
 * 
 */
...
function getParams($params)
{
    ...
    $vsResult = isValidSession($params->session_id);
    if ($vsResult->status_code !== 0) {
    ...
    try {
        ...
        return array('params' => json_encode($response));
    }
    catch (exception $oError) {
      return array('params' => json_encode($oError));
    }
}
