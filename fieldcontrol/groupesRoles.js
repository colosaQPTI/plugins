        ...
        items :[{
            ...
            listeners: {
                keyup: function(val, e){
                    result = val.getValue();
                    text = result;
                    text =  text.replace(/[^a-zA-Z\u00e1\u00c1\u00e9\u00c9\u00ed\u00f3\u00d3\u00fa\u00da 0-9.]+/g,""); // delete spaces in text
                    val.setValue(text);
                },
...
SaveNewRoleAction = function(){
    var text = newForm.getForm().findField('name').getValue();
    text =  text.replace(/[^a-zA-Z\u00e1\u00c1\u00e9\u00c9\u00ed\u00f3\u00d3\u00fa\u00da 0-9.]+/g,""); // delete spaces in text
    Ext.Ajax.request({
...
DeleteRoleAction = function(){
    ...
    gName = rowSelected.data.ROL_CODE;
...
UpdateRoleAction = function(){
    ...
    var text = editForm.getForm().findField('name').getValue();
    text =  text.replace(/[^a-zA-Z\u00e1\u00c1\u00e9\u00c9\u00ed\u00f3\u00d3\u00fa\u00da 0-9.]+/g,"");  
    Ext.Ajax.request({
        url: 'groupsRoles_Ajax.php',
        method: 'POST',
        params: {
...
SaveNewGroupAction = function(){
    var text = newForm.getForm().findField('name').getValue();
    text =  text.replace(/[^a-zA-Z\u00e1\u00c1\u00e9\u00c9\u00ed\u00f3\u00d3\u00fa\u00da 0-9.]+/g,"");
    newForm.getForm().findField('name').setValue(text);
    SaveNewRoleAction();
...
SaveEditGroupAction = function(){
    var text = editForm.getForm().findField('name').getValue();
    text =  text.replace(/[^a-zA-Z\u00e1\u00c1\u00e9\u00c9\u00ed\u00f3\u00d3\u00fa\u00da 0-9.]+/g,"");
    editForm.getForm().findField('name').setValue(text);
...
inboxRelationAction = function(){
    rowSelected = infoGrid.getSelectionModel().getSelected();
    location.href = 'inboxRelationPermission.php?rUID=' + rowSelected.data.ROL_CODE + '&tab=permissions' + '&rolName=' + rowSelected.data.CON_VALUE;
};
